  ...
  return (
    <div className="max-w-[62.5vw] mx-auto my-10 px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative w-fit mx-auto mt-20 group">
        ...
        {/* Botón principal */}
        <button className="relative z-10 px-12 py-5 bg-white/90 hover:bg-white text-xl font-bold font-poppins text-gray-900 rounded-full backdrop-blur-sm shadow-xl hover:scale-105 hover:shadow-2xl transition-all duration-300 ease-in-out whitespace-nowrap">
          ✨ Obtener Acceso Completo por{" "}
          <span className="text-primary font-extrabold">${course?.price}</span>
        </button>
      </div>
