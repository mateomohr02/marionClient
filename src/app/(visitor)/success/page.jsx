    ...
    <div className="h-[calc(100vh-8rem)] flex flex-col items-center justify-center text-center px-4">
      <div className="-translate-y-32 flex flex-col items-center">
        <h1 className="text-3xl font-bold mb-4">
          🎉 ¡Gracias por tu compra, ya formás parte del curso de "nombre"! 🎉
        </h1>

        <p className="text-lg text-gray-700 mb-8 max-w-xl whitespace-nowrap">
          Podrás encontrar los cursos de los que formes parte en { " " }
          <span className="font-semibold text-gray-800 italic underline underline-offset-4">
             Mi Aprendizaje
          </span>
          .
        </p>
